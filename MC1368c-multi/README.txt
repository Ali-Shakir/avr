...
Благодарности: 
Разработчику библиотеки под Ардуино для этого дисплея http://iarduino.ru/file/234.html
...
2 - Vlcd - Напряжение на сегментах. Резистор между этим выводом и выводом питания задает контрастность. Увеличение сопротивления резистора уменьшает контрастрость. 
